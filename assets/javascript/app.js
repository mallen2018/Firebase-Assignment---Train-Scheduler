      ...
      dataRef.ref().child('trains').on('value', function(snapshot){
        ...
        snapshot.forEach(function(childSnapshot){
          ...
          $('tbody').append("<tr class=" + trainClass + "><td>" + trainId.trainName + "</td><td>" +
            ...
            newTime + "</td><td>" +
            timeDiffTotal + "</td><td><button class='edit btn' data-train=" + trainClass + "><i class="far fa-edit"></i></button> <button class='delete btn' data-train=" + trainClass + "><i class="far fa-trash-alt"></i></button></td></tr>");
